...
class TestProblem1:
    @points(0.25, "Problem 1, Part 1: Variable 'basename' is not correctly defined!")
    ...
    @points(0.25, "Problem 1, Part 1: Variable 'filenames' is not an empty list!")
    ...
    @points(0.75, "Problem 1, Part 2: Loop not found in source code!")
    ...
    @points(0.75, "Problem 1, Part 2: Filenames list length is not correct!")
    ...
    @points(0.5, "Problem 1, Part 2: Last item in filenames list not formatted correctly!")
